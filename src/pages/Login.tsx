  ...
  return (
    <ScreenWindow>
      <div className="offset-6 col-6 d-flex flex-column justify-content-center text-center align-items-center secondarysection h-100">
        ...
        {/** Loads spinner if loading, otherwise the log in form is shown */}
        {!loading ? (
          <>
            <form
              onSubmit={emailLogin}
            ...
            <div className="m-2">
              <button className="bg-white text-black" onClick={googleLogin}>
                Sign in with Google
              </button>
            </div>{" "}
          </>
